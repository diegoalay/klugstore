...
//   1. Mapeo explícito de dominios custom (DOMAIN_MAP)
//   2. Subdominio del tipo {slug}.klugstore.app (multi-tenant futuro)
//   3. Fallback de desarrollo: DEFAULT_SLUG
// ============================================
...
export function resolveStoreSlug(hostname?: string): string {
  ...
  // 3. Subdominio pattern: {slug}.klugstore.app (o similares futuras)
  // Ej: tienda2.klugstore.app -> "tienda2"
